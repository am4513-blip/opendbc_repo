...
static bool toyota_stock_longitudinal = true;
...
// #endif
  ...
  toyota_alt_brake = 1; //GET_FLAG(param, TOYOTA_PARAM_ALT_BRAKE);
  toyota_stock_longitudinal = 1; //= GET_FLAG(param, TOYOTA_PARAM_STOCK_LONGITUDINAL);
  toyota_lta = 0;//GET_FLAG(param, TOYOTA_PARAM_LTA);
